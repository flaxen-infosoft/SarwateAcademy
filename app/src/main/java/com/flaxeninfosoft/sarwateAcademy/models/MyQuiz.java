...
public class MyQuiz {
        ...
        public MyQuiz(String id, String catId, String name, String description, String banner, String free, String price, String time, String totalq, String totalm, String creationDate) {
            super();
            this.id = id;
            this.catId = catId;
            this.name = name;
