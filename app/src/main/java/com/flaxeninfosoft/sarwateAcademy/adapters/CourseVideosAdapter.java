...
public class CourseVideosAdapter extends RecyclerView.Adapter<CourseVideosAdapter.VideoHolder> {

    private List<Video> videoList;
    private VideoCardClickListener videoCardClickListener;

    public CourseVideosAdapter(List<Video> videoList, VideoCardClickListener videoCardClickListener) {
